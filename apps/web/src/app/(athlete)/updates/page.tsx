  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <header className="px-6 pt-6 pb-2">
        <h1 className="text-2xl font-bold text-fs-text">Updates</h1>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4">
        <div className="mx-auto max-w-2xl space-y-3">
          {mockUpdates.map((update) => (
            <div
              key={update.id}
              className="rounded-2xl bg-fs-surface px-5 py-4 transition-colors hover:bg-fs-surface-alt"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-0.5 text-sm text-fs-text-muted">
                    {update.description}
                  </p>
                  <p className="mt-1.5 text-xs text-fs-text-muted">
                    {update.time}
                  </p>
                </div>
              </div>
